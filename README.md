...
`jEnv` is configured on my machine to switch between java versions with aliases added in this profile - to switch only for the shell you're currently using
